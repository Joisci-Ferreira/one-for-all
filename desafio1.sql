...
INSERT INTO SpotifyClone.songs (song_name, album_id, seconds_duration)
VALUES
  ("Soul For Us", 1, 200),
...
INSERT INTO SpotifyClone.followArtists (user_id, artist_id)
VALUES
  (1, 1),
  (1, 4),
  (1, 3),
...
INSERT INTO SpotifyClone.historys (user_id, song_id, reproduction_date)
VALUES
